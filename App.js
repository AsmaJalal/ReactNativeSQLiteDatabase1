      ...
      <Stack.Navigator initialRouteName="HomeScreen">
        <Stack.Screen
          ...
          options={{
            ...
            headerStyle: {
              backgroundColor: '#283CD6', //Set Header color
            },
        ...
        <Stack.Screen
          ...
          options={{
            ...
            headerStyle: {
              backgroundColor: '#FF33E6', //Set Header color
            },
            headerTintColor: '#000000', //Set Header text color
            headerTitleStyle: {
              fontWeight: 'bold', //Set Header text style
        ...
        <Stack.Screen
          ...
          options={{
            ...
            headerStyle: {
              backgroundColor: '#ffbf00', //Set Header color
            },
            headerTintColor: '#000000', //Set Header text color
            headerTitleStyle: {
              fontWeight: 'bold', //Set Header text style
        ...
        <Stack.Screen
          ...
          options={{
            ...
            headerStyle: {
              backgroundColor: '#1CFFD4', //Set Header color
            },
            headerTintColor: '#000000', //Set Header text color
            headerTitleStyle: {
              fontWeight: 'bold', //Set Header text style
        ...
        <Stack.Screen
          ...
          options={{
            ...
            headerStyle: {
              backgroundColor: '#48ff1c', //Set Header color
            },
            headerTintColor: '#000000', //Set Header text color
            headerTitleStyle: {
              fontWeight: 'bold', //Set Header text style
        ...
        <Stack.Screen
          ...
          options={{
            ...
            headerStyle: {
              backgroundColor: '#f70714', //Set Header color
            },
            headerTintColor: '#000000', //Set Header text color
            headerTitleStyle: {
              fontWeight: 'bold', //Set Header text style
